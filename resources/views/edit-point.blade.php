    ...
    <script>
        ...
        map.on('draw:edited', function(e) {
            ...
            layers.eachLayer(function(layer) {
                ...
                // menampilkan data terdalam modal
        ...
        var point = L.geoJson(null, {
            onEachFeature: function(feature, layer) {
                ...
                drawnItems.addLayer(
                layer); // memasukkan layer point ke dalam drawnItems, agar ketika objek point di klik bisa dipindahkan
        ...
        $.getJSON("{{ route('api.point', $id) }}", function(data) { // $id tuh dr point controller yg $id di edit data
            point.addData(data);
            map.addLayer(point);

...
class PolygonsModel extends Model
{
    ...
    {
        $polygons = $this->select(DB::raw('polygons.id, st_asgeojson(polygons.geom) as geom,
        polygons.name, polygons.description, polygons.image, st_area(geom,true) as area_m,
        st_area(geom,true)/1000000 as area_km, st_area(geom,true)/10000 as area_hektar,
